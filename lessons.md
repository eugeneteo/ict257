...
| --- | --- | --- | --- | --- |
| 1 | Getting oriented, system documentation, the command-line assistant and the shell | RH124 0A.01, 0A.02, 01.01, 02.01, 02.02, 02.03, 02.04, 02.05, 02.06, 03.01, 03.02, 05.01, 05.02 | RH124 01.02, 02.07, 03.03, 05.03 | RHCSA-1.1, RHCSA-1.11 |
...
| 3 | Editing text, redirecting output, users and groups | RH124 08.01, 09.01, 10.01, 10.03, 10.05, 10.07 | RH124 09.03, 10.02, 10.11 | RHCSA-1.2, RHCSA-1.5, RHCSA-1.7, RHCSA-9.1, RHCSA-9.2, RHCSA-9.3, RHCSA-9.4 |
| 4 | File permissions, RPM packages and Flatpak applications | RH124 10.09, 11.01, 11.03, 11.05, 12.01, 12.03, 12.05, 13.01, 13.03 | RH124 11.02, 11.07, 12.07, 13.05 | RHCSA-1.10, RHCSA-2.1, RHCSA-2.2, RHCSA-2.3, RHCSA-2.4, RHCSA-6.5, RHCSA-7.5, RHCSA-10.2 |
...
A group permissions lab example that accompanies RH124 section 10.07 (Managing Local Group Accounts) is available at [`examples/chapter10-group-permissions-example.md`](examples/chapter10-group-permissions-example.md).
