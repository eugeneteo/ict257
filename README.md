...
| [`skills/rhel10-docs/`](skills/rhel10-docs/) | An assistant skill for RHEL 10 documentation search |
| [`INSTALL.md`](INSTALL.md) | How to install the skill in Claude Code, Antigravity, Codex, or GitHub Copilot |
