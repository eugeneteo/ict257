...
This directory contains worked examples and lab exercises that accompany specific course sections. Each week in [`readings.md`](../readings.md) lists the examples that go with it.

## Contents

The following table lists the available examples and the course sections they supplement:
...
Each example is standalone. To practise the concepts taught in the corresponding course section, work through the example on your own system. These examples complement the guided exercises in the RH124 and RH134 courseware.
